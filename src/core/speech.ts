...
export async function maybeAttachCharacterVoice(input:{character:Character;messageIds:string[];provider:ProviderSettings;signal?:AbortSignal}):Promise<VoiceAttachmentResult>{
